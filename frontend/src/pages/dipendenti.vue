...
export default defineComponent({
  ...
  methods: {
    ...
    disableDipendente(IdDip: number) { 
        ...
        .then(() => {
            this.fetchDipendenti(); // Ricarica la lista dei dipendenti
    ...
    editDipendente(dipendente: Dipendente) {
      ...
      this.form = { ...dipendente }; // Popola il form con i dati del dipendente selezionato
    },
    saveDipendente() {
        const requestData: Omit<Dipendente, 'IdDip'> = {
        ...this.form,
    };
